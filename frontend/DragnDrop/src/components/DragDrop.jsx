...
//   // FUNCTION: Create RNBO Device from model ID
...
//   const [componentChain, setComponentChain] = useState([]); // The current chain of components in the DAW

//   dawAPI.getDawById("587990d4-ede8-475a-a0a6-ee10c067f433").then((daw) => {
//     setDawState(daw);
...
//   // FUNCTION: On drop to board at specific index, update the pedalboard state
...
//   // ON COMPONENT CHAIN CHANGE: Sync the audio graph
//   // useEffect(() => {
